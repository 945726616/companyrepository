...
function class_account_business(obj)
{
        ...
        function cacs_passwd_req(obj)
        {
            ...
            acs.send_msg("cacs_passwd_req", {nid:acs.create_nid(acs.ctrl({type:"get_info"})),
    ...
    var me = this,
            ...
            if(msg && msg.ret && msg.ret.code == "")
            {
                ...
                if(acs.ctrl({type:"ready_login"}))
                {
                    ...
                    else if(msg.type == "IPC")
                    {
                        ...
                        g_ref.device_list_obj["sn_" + msg.sn] = {name:name, Version:Version,type:msg.type, ip:ref.ip, isParent:true,
        ...
        function ccm_get_sub_devices_request(obj)
        {
           if(g_ref.service_options!="IPC"){
               acs.send_msg("ccm_devs_get", {sess:{nid:acs.create_nid(acs.ctrl({type:"get_info"})), sn:device_SerialNumber},
                    start:0, counts:128},
        ...
        function ccm_devs_get_ack(type, msg, ref)
        {
            ...
            if(msg && msg.ret&& msg.ret.code == "")
            {
                ...
                g_ref.device_list_obj["sn_" + ref.sn] = {name:name, type:"MS", ip:ref.ip, isParent:true,
                    state:{online:"Online", view:0, recording:0, call:0, playback:0}};
                devices = msg.devs;
                if(devices)
                {
                    ...
                    for(i = 0; i < length ; ++i)
                    {
                        ...
                        g_ref.device_list_obj["sn_" + devices[i].sn] = {name:name,Version:Version, type:devices[i].type, ip:devices[i].addr, isParent:false, parent_sn:ref.sn,
...
function class_playback_business(obj)
{
        ...
        function ccm_message_search(obj)
        {
            ...
            acs.send_msg("ccm_msg_get", {sess:{nid:acs.create_nid(acs.ctrl({type:"get_info"})), sn:node_sn}, flag:0,
...
function class_view_page_business(obj)
{
        ...
        function get_stream_uri_request(obj)
        {
            ...
            else
            {
             ...
             acs.send_msg("ccm_play", {sess:{nid:acs.create_nid(acs.ctrl({type:"get_info"})), sn:node_sn},
        ...
        function ccm_get_audio_output_stream_uri_request(obj)
        {
            ...
            acs.send_msg("ccm_talk", {sess:{nid:acs.create_nid(acs.ctrl({type:"get_info"})), sn:node_sn},
                setup:{stream:"RTP_Unicast", trans:{proto:obj.protocol}}, token:obj.inner_window_info.profile_token},
        ...
        function get_replay_uri_request(obj)
        {
            ...
            acs.send_msg("ccm_replay", {sess:{nid:acs.create_nid(acs.ctrl({type:"get_info"})), sn:node_sn},
        ...
        function get_snapshot_uri_request(obj)
        {
            ...
            if(!profile_token)
            {
                ...
                else
                {
                    ...
                    acs.send_msg("ccm_snapshot", {sess:{nid:acs.create_nid(acs.ctrl({type:"get_info"})), sn:node_sn},
                         token:"p0"},
        ...
        function relative_move_request(obj)
        {
            ...
            acs.send_msg("ccm_ptz_ctl", {sess:{nid:acs.create_nid(acs.ctrl({type:"get_info"})), sn:node_sn}, token:inner_window_info.ptz_token,
                trans:{pan_tilt:{x:obj.data.pantilt.x, y:obj.data.pantilt.y, space:obj.data.pantilt.space},
                    _deprecated_zoom:{x:obj.data.zoom.x, space:obj.data.zoom.space}},
                speed:{pan_tilt:{x:obj.data.speed.pantilt.x, y:obj.data.speed.pantilt.y, space:obj.data.speed.pantilt.space},
...
function class_home_control_business(obj)
{
    var me = this,
     ...
     function ccm_set_recording_task_config_request(obj)
     {
            ...
            acs.send_msg("ccm_record_task_set", {sess:{nid:acs.create_nid(acs.ctrl({type:"get_info"})), sn:node_sn},
                task:obj},
...
function class_alarm_page_Business(obj)
{
    ...
    me.ctrl=function(obj)
   {
       switch(obj.type)
       {
          case "ccm_message_search":
           {
              acs.send_msg("ccm_msg_get", {sess:{nid:acs.create_nid(acs.ctrl({type:"get_info"})), sn:obj.sn},
         ...
         switch(obj.type)
         {
            case "ccm_pwd_set":
            {
                temp_password=obj.data.pwd;
                 acs.send_msg_ex(g_ref.select_device_ipc, "ccm_pwd_set", {user:[{username:obj.data.username,
...
function options_guest_password_Business(obj)
{
     ...
     me.ctrl=function(obj)
     {
        switch(obj.type)
        {
           case "ccm_pwd_set":
           {
              acs.send_msg_ex(g_ref.select_device_ipc, "ccm_pwd_set", {user:[{username:obj.username,
   ...
   var me =this,
     parent_callback =obj.on_event;
        ...
        function set_network_interfaces_request(obj)
        {
            ...
            acs.send_msg("SetNetworkInterfacesRequest", {sess:{nid:acs.create_nid(acs.ctrl({type:"get_info"})), sn:node_sn},
        ...
        function get_network_default_gateway_request(obj)
        {
            ...
            acs.send_msg("GetNetworkDefaultGatewayRequest", {sess:{nid:acs.create_nid(acs.ctrl({type:"get_info"})), sn:node_sn},
                token:network_token},
        ...
        function set_network_default_gateway_request(obj)
        {
            ...
            acs.send_msg("SetNetworkDefaultGatewayRequest", {sess:{nid:acs.create_nid(acs.ctrl({type:"get_info"})), sn:node_sn},
        ...
        function set_dns_request(obj)
        {
            ...
            acs.send_msg("SetDNSRequest", {sess:{nid:acs.create_nid(acs.ctrl({type:"get_info"})), sn:node_sn},
        ...
        function ccm_connect_wifi_request(obj)
        {
            ...
            acs.send_msg("CcmConnectWifiRequest", {sess:{nid:acs.create_nid(acs.ctrl({type:"get_info"})), sn:node_sn},
                info:obj.info},
        ...
        function ccm_get_network_info_request(filter)
        {
            ...
            set_wifi_config_response_ok = 0;
            acs.send_msg("ccm_net_get", {sess:{nid:acs.create_nid(acs.ctrl({type:"get_info"})), sn:node_sn},
                tokens:["eth0", "ra0"], items:[filter, filter], force_scan:filter=="all"?0:1},
                function(type, msg, ref){
                    if(filter == "all")
                        ccm_net_get_ack(type, msg, ref);
                    else
                        ccm_get_wifi_client_info_response(type, msg, ref);}, {ip:pnode.ip, to:"ccm"});
        }
...
function  options_system_maintenance_Business(obj)
{
     ...
     parent_callback =obj.on_event;
        ...
        function ccm_get_upgrade_status_request(obj)
        {
            ...
            acs.send_msg("ccm_upgrade_get", {sess:{nid:acs.create_nid(acs.ctrl({type:"get_info"})), sn:node_sn},
...
function options_others_Business(obj)
{
     ...
     set_audio_source_config_response_ok = 0;
        ...
        function set_audio_output_config_request(obj)
        {
            ...
            set_audio_output_config_response_ok = 0;
            acs.send_msg("ccm_speaker_set", {sess:{nid:acs.create_nid(acs.ctrl({type:"get_info"})), sn:node_sn},
        ...
        function ccm_set_system_info_request(obj)
        {
            ...
            ccm_set_system_info_response_ok = 0;
            acs.send_msg("ccm_misc_set", {sess:{nid:acs.create_nid(acs.ctrl({type:"get_info"})), sn:node_sn},
                info:obj.info},  //TSH selected框框用数组枚举
         ...
         function set_audio_source_config_request(obj)
        {
            ...
            set_audio_source_config_response_ok = 0;
            acs.send_msg("ccm_mic_set", {sess:{nid:acs.create_nid(acs.ctrl({type:"get_info"})), sn:node_sn},
                conf:obj.conf, force_persistence:1},
