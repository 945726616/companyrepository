...
function mcloud_account(){
    ...
    var _this = this;
    _this.qid = function(){return l_qid};
 	_this.dev_msg_listener_add = dev_msg_listener_add;
 	_this.dev_msg_listener_del = dev_msg_listener_del;
 	_this.set_srv = set_srv; /* set_srv(srv) */
 	_this.get_srv = get_srv;  /* get_srv(srv) */
    _this.get_sharekey = get_share_key;
    _this.get_sid = get_sid;
    _this.pwd_encrypt = pwd_encrypt;/* pwd_encrypt(pwd_md5_hex) */   
    _this.create_nid_ex = create_nid_ex;/* create_nid_ex(type) type:0 by sid, 2: by lid */
    _this.create_nid = create_nid;
    _this.sign_up = function(srv, usr, pwd, pwd_md5_hex, ref, on_ack){ do_sign_x(s_cacs_reg_req, srv, usr, pwd, pwd_md5_hex,ref, on_ack); };
    _this.sign_in = function(srv, usr, pwd, pwd_md5_hex, ref, on_ack){ do_sign_x(s_cacs_login_req, srv, usr, pwd, pwd_md5_hex, ref, on_ack); };
    ...
    _this.send_msg = send_msg;/* send_msg(type, data, ref, on_ack) */
