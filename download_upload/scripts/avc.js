...
if(!(isIE7 || isIE8 || isIE6 || isIE9)) 
{
    ...
    var Avc = (function avc() {
      ...
      function constructor() {
        ...
        this.streamBuffer = toU8Array(Module._broadwayCreateStream(1024 * 1024), 1024 * 1024);
        this.pictureBuffers = {};
        
        this.onPictureDecoded = function (buffer, width, height,img_dom) {
        ...
        _broadwayOnPictureDecoded = function ($buffer, width, height) {
          ...
          this.onPictureDecoded(buffer, width, height,img_dom);
        }.bind(this);
      ...
      constructor.prototype = {
         ...
         */
        decode: function decode(buffer,dom) {
