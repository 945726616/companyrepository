...
(function(window){
    ...
    function record (obj, ref, on_ack) {
        send_msg("ccm_record_task_get", {sess:{nid:create_nid(),sn:obj.sn}},ref, function(msg, ref){
                var result=get_ret(msg);
    ...
    function scene_get(obj,ref,on_ack){
        send_msg("ccm_scene_get",{sess:{nid:mcloud_account.create_nid(),sn:obj.sn}},ref,function(msg,ref){
            var result = get_ret(msg);
            on_ack({result:result,data:msg.data},ref);
        });
    }
    function scene_set(obj,ref,on_ack){
        send_msg("ccm_scene_set",{sess:{nid:mcloud_account.create_nid(),sn:obj.sn},all:obj.all,info:obj.info},ref,function(msg,ref){
            var result = get_ret(msg);
            on_ack({result:result,data:msg.data},ref);
        });
    }
    function exdev_set(obj,ref,on_ack){
        send_msg("ccm_exdev_set",{sess:{nid:mcloud_account.create_nid(),sn:obj.sn},dev:obj.dev},ref,function(msg,ref){
            var result = get_ret(msg);
            on_ack({result:get_ret(msg),data:msg.data},ref);
        });
    }
    function exdev_get(obj,ref,on_ack){
        send_msg("ccm_exdev_get",{sess:{nid:mcloud_account.create_nid(),sn:obj.sn},id:obj.id,flag:obj.flag,start:obj.start,counts:obj.counts},ref,function(msg,ref){
            var result = get_ret(msg);
            on_ack({result:get_ret(msg),data:msg.data},ref);
        });
    }
    function  exdev_discover(obj,ref,on_ack){
        send_msg("ccm_exdev_discover",{sess:{nid:mcloud_account.create_nid(),sn:obj.sn},flag:obj.flag,timeout:obj.timeout,interval:obj.interval},ref,function(msg,ref){
            var result = get_ret(msg);
            on_ack({result:result,data:msg.data},ref);
        });
    }
    function exdev_add(obj,ref,on_ack){
        send_msg("ccm_exdev_add",{sess:{nid:mcloud_account.create_nid(),sn:obj.sn},id:obj.id,model:obj.model},ref,function(msg,ref){
            var result = get_ret(msg);
            on_ack({result:result,data:msg.data},ref);  
        });
    }
    ...
    function schedule_get(obj,ref,on_ack){
        send_msg("ccm_schedule_get",{sess:{nid:mcloud_account.create_nid(),sn:obj.sn}},ref,function(msg,ref){
            var result = get_ret(msg);
            on_ack({result:result,data:msg.data},ref);
        });
    }
    function schedule_set(obj,ref,on_ack){
        send_msg("ccm_schedule_set",{sess:{nid:mcloud_account.create_nid(),sn:obj.sn},sch:obj.sch},ref,function(msg,ref){
            var result = get_ret(msg);
            on_ack({result:result,data:msg.data},ref);
        });
    }
    ...
    function time_zone_get(obj,ref,on_ack){
        send_msg("ccm_zone_get",{sess:{nid:mcloud_account.create_nid(),sn:obj.sn},dev_sn:obj.dev_sn},ref,function(msg,ref){
          var result = get_ret(msg);
          if(result == "" && msg.data){
            on_ack({result:result,data:msg.data},ref);
          }
...
window.mcloud_agent = {
        ...
        hardware_test_get:hardware_test_get,
        rf_test:rf_test,
        get_download:get_download,
        feedback_submit:feedback_submit,
        test_ptz_ctrl:test_ptz_ctrl
};
})(window);
