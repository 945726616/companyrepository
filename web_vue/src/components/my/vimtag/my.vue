        ...
        <div id='set_main'>
            <div id='set_left' v-if='my_enter_list.my_page'>
                ...
                <ul id='left_ul_top' class='ul_public' :style="(!fujikam_sign && login_sign) || !login_sign?'border:inherit':''">
                    <li class='set_list' id='local_div_hide' v-if="fujikam_sign">
                ...
                <ul id='left_ul_bottom' class='ul_public' :style="!login_sign?'border:inherit':''">
                    <li class='set_list' v-if="auto_play_sign" @click="enter_page">
            ...
            <div id='set_right'>
                ...
                <div id='set_right_content'>
                    ...
                    <!-- 自动播放 -->
                    <div id='set_auto_play_page' class='set_page' style='width:400px;' v-if='my_enter_list.auto_play'>
                        <div id='set_auto_play_box'>
                            <div class='set_auto_play_box_name'> {{mcs_auto_play}} </div>
                            <div style='float:right'><input id='set_auto_play_btn' class='set_auto_play_on' type='checkbox'></div>
                        </div>
                    </div>
...
<script>
    ...
    export default {
        ...
        components: { ManagePassword, AddEmail, GuestPassword,Feedback }
    }
</script>
